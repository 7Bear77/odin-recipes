This is the first project that I am working on through The Odin Project (TOP). With this project I will demonstrate the use of some basic HTML coding, and may later come back to add styling through CSS. I will use images, links, and lists to create a recpies website. I will also demonstrate proper Git-commit etiquette.
